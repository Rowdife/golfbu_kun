...
class NewScoreCardView extends ConsumerStatefulWidget {
  const NewScoreCardView({
    super.key,
    required this.scoreCardData,
  });
  final NewScoreCardDataModel scoreCardData;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _NewScoreCardViewState();
}

class _NewScoreCardViewState extends ConsumerState<NewScoreCardView> {
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ScoreCardDataTile(
                          title: "オーバー数",
                          data:
                              "${scoreCard.parOnShotMissedOver} / ${scoreCard.parOnResultCount}"),
                      ScoreCardDataTile(
                          title: "ショート数",
                          data:
                              "${scoreCard.parOnShotMissedShort} / ${scoreCard.parOnResultCount}"),
                      ScoreCardDataTile(
                          title: "左外し数",
                          data:
                              "${scoreCard.parOnShotMissedLeft} / ${scoreCard.parOnResultCount}"),
                      ScoreCardDataTile(
                          title: "右外し数",
                          data:
                              "${scoreCard.parOnShotMissedRight} / ${scoreCard.parOnResultCount}"),
                      const Gap(20),
                      const Text(
                        "パーオン距離別分析",
                        style: TextStyle(
