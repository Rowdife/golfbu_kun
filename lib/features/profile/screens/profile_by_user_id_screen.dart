...
class ProfileByUserIdScreen extends ConsumerStatefulWidget {
  static const routeURL = '/profileinfo';
  const ProfileByUserIdScreen({
    super.key,
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ProfileByUserIdScreenState();
}

class _ProfileByUserIdScreenState extends ConsumerState<ProfileByUserIdScreen>
  ...
  void _dataInitialize() async {
    profile = await ref
        ...
        .fetchProfileByUserId(widget.userId);
    await ref
        .read(scoreCardMyHisotryProvider.notifier)
        .fetchScoreCardsDataByUserId(widget.userId);
    await ref
        .read(timelineByUserProvider.notifier)
        .fetchVideosById(widget.userId);
    await ref
        .read(scoreDataProvider.notifier)
        .fetchScoreCardDataById(id: widget.userId);
  }
  ...
  Future<void> _onAvatarTap() async {
    ...
    if (xfile != null) {
      ...
      await ref
          ...
          .updateAvatarById(file, widget.userId);
    }
  }
                  ...
                  child: CustomScrollView(
                    slivers: [
                      SliverAppBar(
                        ...
                        actions: [
                          widget.userId == ref.read(authRepo).user!.uid
                              ? IconButton(
                                  onPressed: () {
                              ...
                              children: [
                                isLoading
                                    ...
                                    : CircleAvatar(
                                        ...
                                        child: ClipOval(
                                          child: Image.network(
                                              "https://firebasestorage.googleapis.com/v0/b/golfbukun.appspot.com/o/avatars%2F${widget.userId}?alt=media&token=${Random().nextInt(100)}",
                                              width: 100,
                                              height: 100,
